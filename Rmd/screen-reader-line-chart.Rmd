---
title: '{highcharter} recreation of desktop screen readers line chart'
author: "Mara Averick"
date: "10/24/2021"
...
Attempt to recreate the [first example](https://www.highcharts.com/docs/accessibility/accessibility-module) from the Highcharts accessibility module documentation as an htmlwidget using Joshua Kunst's [{highcharter}](https://jkunst.com/highcharter/index.html) R package.
